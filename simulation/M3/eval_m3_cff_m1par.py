...
from params import sotexs_1200_m1par_sim_name
...
BL_file_path = os.path.join(f'RAYPy_Simulation_{sotexs_1200_m1par_sim_name}', 'ExitSlit_RawRaysOutgoing.csv')
...
for m3_radius in m3_radius_list:
    ...
    # Save the the figure
    plt.tight_layout()
    plt.savefig(f'plot/sotexs_cff_m1_par_m3radius{m3_radius}.png')
    # plt.show()
