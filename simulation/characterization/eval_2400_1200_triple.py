...
plt.tight_layout()
plt.savefig('plot/SoTeXS_1200triple_2400.png')
plt.close()
...
plt.suptitle('SoTeXS, ES=30 µm')
plt.tight_layout()
plt.savefig('plot/SoTeXS_1200triple_2400_multilayer_efficiency.png')
...
plt.suptitle('SoTeXS, ES=30 µm')
plt.tight_layout()
plt.savefig('plot/SoTeXS_1200triple_2400_flux_density.png')
