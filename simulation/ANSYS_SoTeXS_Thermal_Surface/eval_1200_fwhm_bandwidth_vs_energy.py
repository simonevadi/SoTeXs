...
ax2.set_title('1200: DetectorAtFocus center scatter (colored by energy)')
ax2.grid(True, alpha=0.3)
ax2.legend()
fig2.tight_layout()
out_png2 = os.path.join(base_dir, 'results', 'plots', 'eval_1200_detector_center_scatter.png')
...
axs3[0].set_title('1200: DetectorAtFocus Horizontal FWHM vs Energy')
axs3[0].grid(True, alpha=0.3)
axs3[0].legend()

axs3[1].set_xlabel('Photon Energy [eV]')
axs3[1].set_ylabel('VerticalFocusFWHM [mm]')
axs3[1].set_title('1200: DetectorAtFocus Vertical FWHM vs Energy')
axs3[1].grid(True, alpha=0.3)
axs3[1].legend()

fig3.tight_layout()
out_png3 = os.path.join(base_dir, 'results', 'plots', 'eval_1200_detector_focus_fwhm_vs_energy.png')
